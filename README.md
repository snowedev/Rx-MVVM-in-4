...
<img width=20% src="https://user-images.githubusercontent.com/42789819/132990134-59fbc960-0620-429a-9507-a1674ed4ea66.png">
...
그래서 위와 같이 동작하는 유틸리티들(PromiseKit, Bolt)이 생겨남!
...
### 4. Observable의 생명주기  / create(), subscribe()
...
5. Disposed
   ...
   > 4번에서 onCompleted / onError 뭐가 되더라도 결국 끝 지점은  Disposed
...
### 쓰레드 분기 `observeOn, subscribeOn` / [설명](http://reactivex.io/documentation/operators/observeon.html)
